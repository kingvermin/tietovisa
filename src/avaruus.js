...
//m‰‰ritet‰‰n oikeat vastaukset tekstikent‰llisille kysymyksille
...
new TextView({
  ...
  alignment: 'left',
  font: "16px",
  text: '1. Mik‰ on planeetta Maan latinankielinen nimitys?'
}).appendTo(parent1);
...
new TextView({
  id: 'Q2Label',
  font: "16px",
  text: '2. Mik‰ seuraavista ei ole planeetta?'
}).appendTo(parent2);
...
new TextView({
  id: 'Q3Label',
  font: "16px",
  text: '3. Mink‰ niminen oli ensimm‰inen Kuun kamaralle laskeutunut miehitetty avaruuslento?'
}).appendTo(parent3);
...
new TextView({
  id: 'Q5Label',
  font: "16px",
  text: '5. Mik‰ seuraavista ei ole Saturnuksen kuu?'
}).appendTo(parent5);
...
new TextView({
  ...
  alignment: 'left',
  font: "16px",
  text: '6. Mink‰ niminen on Linnunrataa l‰hin suuri galaksi?'
}).appendTo(parent6);
...
new TextView({
  id: 'Q7Label',
  font: "16px",
  text: '7. Kuinka kauan kest‰‰ Maan kierros Auringon ymp‰ri?'
}).appendTo(parent7);

['P‰iv‰n', 'Kuukauden', 'Vuoden'].forEach((title) => {
  new RadioButton({
    id: 'Q7options',
    font: "16px",
    left: 30, top: 'prev() 18',
...
new TextView({
  id: 'Q8Label',
  font: "16px",
  text: '8. Mik‰ on supernova?'
}).appendTo(parent8);

['Meteoriittisade', 'T‰hden r‰j‰hdys', 'Valon aallonpituus'].forEach((title) => {
  new RadioButton({
    id: 'Q8options',
    font: "16px",
    left: 30, top: 'prev() 18',
...
new TextView({
  id: 'Q9Label',
  font: "16px",
  text: '9. Mik‰ seuraavista ei ole taivaankappale?'
}).appendTo(parent9);
...
new TextView({
  ...
  alignment: 'left',
  font: "16px",
  text: '10. Mink‰ niminen oli ensimm‰inen el‰v‰ olento Maan kiertoradalla? (Vihje: koira)'
}).appendTo(parent10);
...
let button1 = new Button({
  ...
  //jos yksi tai useampi radiobutton-vastaus on tyhj‰ -> virhe
  if (usertext2.text == "" || usertext3.text == "" || usertext4.text == "" || usertext5.text == "" || usertext7.text == "" || usertext8.text == "" || usertext9.text == "") {
    ...
    // poimitaan usertext-muuttujiin k‰ytt‰j‰n syˆtt‰m‰t tekstikentt‰-vastaukset
    ...
    // vastaus 1 oikein -> piste
     ...
     if (usertext8.text == "T‰hden r‰j‰hdys") {
        i++;
     }
     ...
     if (usertext10 == A10 || usertext10 == A10_2) {
   	 ...
   	 //n‰ytet‰‰n score-label
      score.set("text","Pisteesi: " + i + "/10");

     //n‰ytet‰‰n tulos-label
      //0-3 pistett‰
      if (i < 4) {
      	tulos.set("text","Voi r‰hm‰, mets‰‰n meni! Sinulla on parantamisen varaa, mutta eth‰n silti luovuta viel‰.");
      //4-7 pistett‰
      } else if (i > 3 && i < 8) {
          tulos.set("text","Ei paha! Sinulla on selv‰sti tiet‰myst‰ aiheesta.");
      //8-10 pistett‰
      } else {
          tulos.set("text","Vau! Sin‰ taidatkin olla melkoinen ydinfyysikko!");
      }
